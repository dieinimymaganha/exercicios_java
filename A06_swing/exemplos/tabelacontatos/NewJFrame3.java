...
public class NewJFrame3 extends javax.swing.JFrame {
    ...
    private ModeloTabelaContatos meuModelo;
    /**
     * Creates new form NewJFrame3
     */
    public NewJFrame3() {
        meuModelo = new ModeloTabelaContatos();
        initComponents();
    }
    ...
    private void listarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listarMouseClicked
        try{
            ...
            meuModelo.setListaContatos(lista);
        }catch(SQLException ex){
            JOptionPane.showMessageDialog(null, "Problema de conexão com o banco de dados. Contate o administrador. Mensagem: " + ex.getMessage());
        } 
